...
const char* CSysInfo::GetTSClientProtocolType(DWORD sessionID)
{
    LPTSTR  ppBuffer			   = NULL;
    DWORD   pBytesReturned	       = 0;
    const char*  clientProtocolTypeStr=NULL;
...
DWORD CSysInfo::StopFire()
{
    ...
    const char*ServerName = "sharedaccess";
